...
import com.wooma.business.adapter.InventoryMetersAdapter
import com.wooma.business.data.network.ApiResponseListener
import com.wooma.business.data.network.MyApi
import com.wooma.business.data.network.makeApiRequest
import com.wooma.business.data.network.showToast
import com.wooma.business.databinding.ActivityInventoryMeterListBinding
...
class MeterListingActivity : BaseActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        adapter = InventoryMetersAdapter(this, metersList, reportId)
