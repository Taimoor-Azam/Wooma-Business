...
import com.wooma.business.databinding.ActivityFullscreenImageBinding
        ...
        val pagerAdapter = object : RecyclerView.Adapter<RecyclerView.ViewHolder>() {
            ...
            override fun onBindViewHolder(holder: RecyclerView.ViewHolder, position: Int) {
                ...
                when (val item = mutableImages[position]) {
                    is ImageItem.Remote -> Glide.with(this@FullscreenImageActivity).load(item.url).into(iv)
                    is ImageItem.Local -> Glide.with(this@FullscreenImageActivity).load(item.uri).into(iv)
                }
            }
        }
